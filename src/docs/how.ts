...
export const HOW_LEDE =
  "OpenXPost is an open microphone on our X account, @OpenXPost. You send 10,000 tokens. Those tokens are burned. We post your text. The tweet link comes back on this site. You are not buying a For You slot.";
...
export const HOW_SECTIONS: HowSection[] = [
  {
    title: "10,000 tokens, then burn",
    paragraphs: [
      "Price is exactly 10,000 tokens.",
      "You connect a wallet (Phantom, Solflare, or a wallet-standard wallet) and sign a transfer of exactly 10,000 tokens to a fresh per-order receive address. We look up the mint’s decimals over RPC. We do not assume 6 or 9.",
  ...
  },
  {
    ...
    paragraphs: [
      "After you send, we poll the receive associated token account for the inbound 10,000. The UI moves waiting → paid → burning → done.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "One post per 10,000-token payment.",
    ],
  },
  {
    title: "Post on X",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "OpenXPost does not buy distribution. It does not touch For You. It does not place you in anyone else’s timeline by force. You pay 10,000 tokens to speak on our account. Those tokens are burned. That is the whole product.",
    ],
  },
  {
